...
- Idempotency schema evolution guardrail: when changing unique scope (global -> composite), make rollback data-safe by normalizing preexisting collisions before re-adding tighter uniqueness, and in services treat duplicate-key retries as constraint-specific (index-aware + SQLSTATE-aware), not generic integrity errors.
